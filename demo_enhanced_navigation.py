...
def main():
    ...
    print("This demo showcases DF/Rimworld-style navigation improvements for Years of Lead.")
    print("Features include number key navigation, escape functionality, and multi-pane layouts.")
