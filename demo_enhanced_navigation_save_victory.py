...
def demonstrate_save_load():
    ...
    saves = [
        {"name": "resistance_turn_12", "turn": 12, "date": "2025-06-10", "agents": 5, "support": 42, "progress": "38%", "type": "Manual"},
        {"name": "university_mission", "turn": 8, "date": "2025-06-08", "agents": 4, "support": 38, "progress": "25%", "type": "Manual"},
        {"name": "autosave_turn_15", "turn": 15, "date": "2025-06-12", "agents": 6, "support": 51, "progress": "45%", "type": "Autosave"},
        {"name": "victory_turn_30", "turn": 30, "date": "2025-06-15", "agents": 8, "support": 78, "progress": "100%", "type": "Victory"}
    ]
    
    for i, save in enumerate(saves, 1):
        print(f"{i:<3} {save['name'][:20]:<20} {save['turn']:<5} {save['date'][:20]:<20} {save['agents']:<7} {save['support']}%{'':<3} {save['progress']:<10} {save['type']:<8}")
