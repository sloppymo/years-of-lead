#!/usr/bin/env python3
"""
Years of Lead - Game Launcher (Fixed Terminal Handling)
...
def main():
    """Main entry point with proper terminal handling"""
    print("\033[?25h")  # Ensure cursor is visible at start
    ...
    try:
        ...
        os.system('stty sane 2>/dev/null')  # Reset terminal
