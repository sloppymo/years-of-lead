...
if __name__ == "__main__":
    ...
    test_suite.addTests(test_loader.loadTestsFromName('tests.unit.test_save_load_system'))
    test_suite.addTests(test_loader.loadTestsFromName('tests.unit.test_victory_defeat_conditions'))
    test_suite.addTests(test_loader.loadTestsFromName('tests.unit.test_integrated_features'))
