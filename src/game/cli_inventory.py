...
def cli_inventory_menu(equipment_manager: EnhancedEquipmentManager, integration_manager: EquipmentIntegrationManager, agents: list, storage: dict, safehouses: dict = None):
    ...
    while True:
        ...
        if choice == '1':
            ...
            cli_move_equipment_storage_agent(equipment_manager, integration_manager, agents, storage)
        elif choice == '3':
...
def cli_move_equipment_storage_agent(equipment_manager, integration_manager, agents, storage):
    clear_screen()
...
def cli_view_agent_inventories(integration_manager: EquipmentIntegrationManager, agents: list):
    clear_screen()
