...
class GameEngine:
    ...
    def _validate_action(self, action_data: Dict[str, Any]) -> bool:
        ...
        for field in required_fields:
            if field not in action_data:
                logger.warning(
                    f"Action validation failed: missing required field '{field}'"
                )
                return False
        ...
        if action_type not in valid_action_types:
            logger.warning(
                f"Action validation failed: invalid action type '{action_type}'"
            )
            return False
    ...
    async def save_game(self) -> Dict[str, Any]:
        ...
        try:
            ...
            save_data = {
                ...
                "faction_data": await self.faction_manager.serialize()
                if self.faction_manager
                else {},
                "event_history": self.event_manager.get_history()
            ...
            return {"success": False, "error": str(e), "message": "Failed to save game"}
    ...
    async def load_game(self, game_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": str(e), "message": "Failed to load game"}
