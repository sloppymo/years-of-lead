...
class MissionState:
    ...
    relationship_changes: Dict[str, Dict[str, float]]  # agent_id -> {relationship_id -> change}
...
class InfiltrationMissionFlow:
    ...
    def execute_mission(self) -> Dict[str, Any]:
        ...
        self.state.narrative_log.append("Mission initialized. Beginning infiltration...")
    ...
    def _handle_preparation(self):
        ...
        self.state.player_choices.append({"phase": "preparation", "choice": selected_option})
    ...
    def _handle_execution(self):
        ...
        if random() > 0.3:  # 70% chance of success
            ...
            self.state.narrative_log.append("⚠️  Alarm triggered! Security is on high alert!")
    ...
    def _is_mission_complete(self) -> bool:
        ...
        return self.state.current_phase == MissionPhase.AFTERMATH or self.state.turns_elapsed >= 10
