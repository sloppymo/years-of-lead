...
class EnhancedNavigation:
    ...
    def handle_input(self, user_input: str) -> str:
        ...
        if self.number_navigation and user_input in [
            "1",
            "2",
            "3",
            "4",
        ...
        current_layout = self.pane_layouts.get(
            self.current_pane, self.pane_layouts["main"]
        )
    ...
    def _display_mission_multi_pane(self, width: int, height: int):
        ...
        print(
            f"{'MISSION LIST':<{left_width}} | {'PLANNING':<{center_width}} | {'STATUS':<{right_width}}"
        )
        ...
        for i, mission in enumerate(missions):
            ...
            if i == self.selected_index:
                ...
                right_content = "Status: Planning"
            else:
                center_content = ""
                right_content = ""

            print(
                f"{left_content:<{left_width}} | {center_content:<{center_width}} | {right_content:<{right_width}}"
            )
    ...
    def _display_intelligence_multi_pane(self, width: int, height: int):
        ...
        print(
            f"{'INTEL EVENTS':<{left_width}} | {'PATTERNS':<{center_width}} | {'ALERTS':<{right_width}}"
        )
        print("-" * left_width + "-+-" + "-" * center_width + "-+-" + "-" * right_width)
