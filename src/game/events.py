...
class EventSystem:
    ...
    def __init__(self, game_state=None):
        ...
        self.recent_events = []
        self.recently_used_templates = []  # Track recently used templates to avoid repetition
        ...
        self.fallbacks = {
            ...
            'destination': ['the government facility', 'the checkpoint', 'the warehouse'],
            'hiding_place': ['a basement', 'an abandoned building', 'a secret cache'],
            'relative': ['family', 'a loved one', 'someone from home'],
            'district': ['the city center', 'the industrial zone', 'the residential area'],
        ...
        return {
            'daily_life': [
                ...
                },
                {
                    ...
                    'consequences': {'dignity_defended': True, 'cop_abuse_witnessed': True}
                },
                {
    ...
    def generate_event(self, event_category: str, context: Dict[str, Any] = None) -> Optional[Dict[str, Any]]:
        ...
        if not available_templates:
            ...
            available_templates = [(i, template) for i, template in enumerate(templates)]
    ...
    def _resolve_agent_name(self, context: Dict[str, Any]) -> str:
        ...
        if self.game_state and self.game_state.agents:
            ...
            active_agents = [agent for agent in self.game_state.agents.values()
    ...
    def _resolve_cell_leader(self, context: Dict[str, Any]) -> str:
        ...
        if self.game_state and self.game_state.agents:
            ...
            for agent in self.game_state.agents.values():
                if (agent.status.value == 'active' and
                    hasattr(agent.skills, 'get') and
                    agent.skills.get('persuasion', 0).level > 2):
    ...
    def _resolve_resource_type(self, context: Dict[str, Any]) -> str:
        ...
        resource_types = ['medical supplies', 'weapons', 'food', 'communications equipment',
                         'explosives', 'intelligence documents', 'money', 'clothing']
        import random
    ...
    def _resolve_destination(self, context: Dict[str, Any]) -> str:
        ...
        destinations = ['the government facility', 'the military checkpoint', 'the police station',
                       'the warehouse district', 'the port', 'the airport']
        import random
    ...
    def _resolve_hiding_place(self, context: Dict[str, Any]) -> str:
        ...
        hiding_places = ['a basement', 'an abandoned building', 'a secret cache', 'a tunnel',
                        'a rooftop', 'a sewer', 'an attic', 'a cellar']
        import random
    ...
    def _resolve_relative(self, context: Dict[str, Any]) -> str:
        ...
        relatives = ['family', 'a loved one', 'someone from home', 'an old friend',
                    'a childhood companion', 'a distant relative']
        import random
    ...
    def _resolve_district(self, context: Dict[str, Any]) -> str:
        ...
        districts = ['the city center', 'the industrial zone', 'the residential area',
                    'the university district', 'the old town', 'the suburbs']
        import random
    ...
    def _resolve_city(self, context: Dict[str, Any]) -> str:
        ...
        cities = ['the city', 'this place', 'your home', 'the capital', 'the metropolis']
        import random
    ...
    def _substitute_variables(self, template: str, context: Dict[str, Any]) -> str:
        ...
        try:
            ...
            try:
                ...
                safe_substitutions = {}
                for var_name in variables:
                    safe_substitutions[var_name] = substitutions.get(var_name, f"{{{var_name}}}")
