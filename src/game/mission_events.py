...
class MissionEventGenerator:
            ...
            EventCategory.SECURITY: [
                {
                    ...
                    "choices": [
                        ...
                        },
                        {
                            ...
                            "failure_consequences": [
                                "Diversion fails, security heightened"
                            ],
                        },
                    ],
                },
                    ...
                    "choices": [
                        {
                            ...
                            "success_consequences": [
                                "Alarm disabled, security confused"
                            ],
                            "failure_consequences": [
                                "Lockdown initiated",
                                "escape_routes_blocked",
                            ],
                        },
                        {
                            ...
                            "success_consequences": [
                                "Alarm destroyed, brief window to escape"
                            ],
                            "failure_consequences": [
                                "Explosion alerts entire facility",
                                "heavy_response",
                            ],
                        },
                    ],
                    ...
                    "choices": [
                        {
                            ...
                            "failure_consequences": [
                                "Witness reports suspicious activity",
                    ...
                    "choices": [
                        {
                            ...
                            "success_consequences": [
                                "Weather provides excellent cover"
                            ],
                            "failure_consequences": [
                                "Disoriented by conditions",
                                "equipment_damaged",
                            ],
                        },
                        {
                    ...
                    "choices": [
                        {
                            ...
                            "failure_consequences": [
                                "Repair fails, must abort objective",
                                "time_wasted",
                            ],
                        },
                        {
                    ...
                    "choices": [
                        {
                            ...
                            "required_skill": SkillType.PERSUASION,
                            "success_consequences": [
                                "Informant reveals double agent status",
                                "new_intel",
                            ],
                            "failure_consequences": [
                                "Walking into trap",
                    ...
                    "choices": [
                        {
                            ...
                            "required_skill": SkillType.INTELLIGENCE,
                            "success_consequences": [
                                "Ally provides crucial assistance",
                                "new_escape_route",
                            ],
                            "failure_consequences": [
                                "Ally is government plant",
                                "ambush",
                            ],
                        },
                        {
                    ...
                    "choices": [
                        {
                            ...
                            "required_skill": SkillType.INTELLIGENCE,
                            "success_consequences": [
                                "Safe extraction to secure location"
                            ],
                            "failure_consequences": [
                        ...
                        },
                        {
                            ...
                            "required_skill": SkillType.STEALTH,
                            "success_consequences": [
                                "Successfully hidden among civilians"
                            ],
                            "failure_consequences": [
                                "Checkpoints everywhere",
                                "detained_for_questioning",
                            ],
                        },
                    ],
                },
                ...
                },
                {
                    ...
                    "choices": [
                        ...
                        },
                        {
                            ...
                            "required_skill": None,
                            "success_consequences": [
                                "Mission continues with substitute"
                            ],
                            "failure_consequences": [
                                "Team cohesion damaged",
                                "efficiency_reduced",
                            ],
                        },
                    ],
    ...
    def generate_event(
        ...
        possible_events = [
            template
            for template in self.event_templates[category]
        ...
        return self._create_event_from_template(
            template, category, mission, location, agents
        )

    def _calculate_event_probability(
        self, mission: Mission, location: Location
    ) -> float:
        ...
        return min(
            0.8, base_probability + security_modifier + risk_modifier + phase_modifier
        )

    def _select_event_category(
        self, mission: Mission, location: Location, agents: List[Agent]
    ) -> EventCategory:
        ...
        weights = {
            ...
            EventCategory.PERSONAL: sum(agent.stress for agent in agents)
            / (len(agents) * 10),
        }
        ...
        if mission.mission_type in [MissionType.ASSASSINATION, MissionType.SABOTAGE]:
            ...
            MissionType.PROPAGANDA_CAMPAIGN,
            MissionType.RECRUITMENT_DRIVE,
        ]:
    ...
    def _generate_consequences(
        self, template: Dict[str, Any], severity: float
    ) -> List[str]:
        ...
        if severity > 0.7:
            base_consequences.extend(
                ["mission_compromised", "heavy_security_response", "agent_captured"]
            )
        elif severity > 0.4:
            base_consequences.extend(
                ["increased_security", "time_pressure", "partial_exposure"]
            )
        else:
            base_consequences.extend(
                ["minor_delay", "stress_increase", "resource_loss"]
            )
