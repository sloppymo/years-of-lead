...
from .enhanced_mission_flows import (
    InfiltrationMissionFlow, MissionState, MissionPhase,
    MissionChoice, ChoiceOutcome
)
...
class EnhancedPlayerInterface:
    ...
    def execute_mission_with_choices(self, mission: Mission, agents: List[Agent]) -> Dict[str, Any]:
        """
    ...
    def _execute_assassination_mission(self, mission_state: MissionState) -> Dict[str, Any]:
        ...
        for agent in mission_state.agents:
            ...
            if hasattr(agent, 'trauma_flags') and 'pacifist_drift' in agent.trauma_flags:
                moral_objections.append(f"{agent.name} has developed pacifist tendencies")
            if getattr(agent, 'stress', 0) > 70:
                moral_objections.append(f"{agent.name} may not be psychologically ready for killing")
            ...
            options=[
                {
                    ...
                    "consequences": {"lethality": "high", "psychological_trauma": "severe"},
                    "requirements": {}
                },
                {
        ...
        if result.get("consequences", {}).get("mission_failure"):
            return self._create_mission_result("aborted", "Team chose to preserve moral integrity")
    ...
    def _handle_capture_scenario(self, mission_state: MissionState) -> Dict[str, Any]:
        ...
        print("Through the kitchen window: Martinez cooking dinner, checking his phone.")
        ...
        for agent in mission_state.agents:
            if hasattr(agent, 'background'):
                if agent.background == "family_oriented":
                    agent_reactions.append(f"{agent.name} whispers: 'He's just making pasta. Like anyone's dad would.'")
                elif agent.background == "vengeful":
                    agent_reactions.append(f"{agent.name}'s jaw tightens: 'Don't make him human to me.'")
        ...
        choice = MissionChoice(
            ...
            options=[
                ...
                },
                {
                    ...
                    "consequences": {"complexity": "medium", "moral_preservation": "partial"},
                    "requirements": {"tactical_flexibility": 60}
                },
                {
                    "text": "Abort mission - 'We're not killers of fathers'",
                    "consequences": {"mission_failure": True, "moral_high_ground": True},
                    "requirements": {}
                },
                {
    ...
    def _handle_intelligence_revelation(self, mission_state: MissionState) -> Dict[str, Any]:
        ...
        maria = next((agent for agent in mission_state.agents if "Maria" in agent.name), None)
        if maria:
            ...
            options=[
                {
                    ...
                    "consequences": {"truth_revealed": True, "worldview_shattered": True},
    ...
    def _handle_truth_revelation(self, mission_state: MissionState, maria_agent) -> Dict[str, Any]:
        """Handle the devastating truth revelation"""
        print("\n📄 Evidence Review")
        print("The documents are real. Photos of Miguel with explosive materials, school blueprints.")
        print("But the photos also show he was coerced - threatening notes about Maria's safety.")
        ...
        if maria_agent:
            ...
            if hasattr(maria_agent, 'trauma_flags'):
                maria_agent.trauma_flags.extend(["worldview_collapse", "betrayal_by_allies", "brother_truth"])
            
            # Relationship changes - trust in faction leadership plummets
            mission_state.relationship_changes[maria_agent.id] = {"faction_loyalty": -50}
        ...
        choice = MissionChoice(
            ...
            options=[
                ...
                },
                {
                    ...
                    "consequences": {"ally_protection": True, "faction_betrayal_risk": True},
        ...
        return self._create_mission_result("life_changing", 
            "Mission outcome: Worldview shattered, new alliance forged, truth discovered")
    
    def _execute_recruitment_mission(self, mission_state: MissionState) -> Dict[str, Any]:
            ...
            options=[
                {
                    ...
                    "consequences": {"approach": "ideological", "time": "fast", "loyalty": "high"},
                    "requirements": {"social_skill": 70}
                },
                {
                    "text": "Financial incentive - 'We can help with your debts'",
                    "consequences": {"approach": "financial", "loyalty": "transactional", "guilt": "medium"},
                    "requirements": {}
                },
                {
                    "text": "Protection offer - 'We'll keep you and your son safe'",
                    "consequences": {"approach": "protective", "fear_based": True, "compliance": "high"},
                    "requirements": {}
                },
                {
                    "text": "Gradual friendship - 'Build trust over time'",
                    "consequences": {"approach": "friendship", "time": "slow", "loyalty": "genuine"},
                    "requirements": {"patience": True}
                }
            ],
    ...
    def _handle_direct_recruitment(self, mission_state: MissionState, approach: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if approach_type == 'ideological':
            ...
            print("You show her evidence of covered-up murders in the 'suicide' reports.")
                ...
                options=[
                    {
                        ...
                        "consequences": {"success": True, "loyalty": "high", "motivation": "ideological"}
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "consequences": {"success": "delayed", "next_step": "follow_up"}
                    }
                ]
            )
                ...
                options=[
                    {
                        ...
                        "consequences": {"success": True, "loyalty": "transactional", "motivation": "financial"}
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "consequences": {"success": "delayed", "next_step": "build_trust"}
                    }
                ]
            )
                ...
                options=[
                    {
                        ...
                        "consequences": {"success": True, "loyalty": "fear_based", "motivation": "protection"}
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "consequences": {"success": "delayed", "next_step": "demonstrate_protection"}
                    }
                ]
            )
    ...
    def _handle_friendship_recruitment(self, mission_state: MissionState) -> Dict[str, Any]:
        ...
        social_agent = max(mission_state.agents, 
                          key=lambda a: getattr(a, 'social_skill', 0))
            ...
            options=[
                {
                    ...
                    "consequences": {"trust_gain": +20, "vulnerability": "mutual", "bond": "deep"},
                    "requirements": {"empathy": 60}
                },
                {
                    "text": "Professional interest - Ask about her work",
                    "consequences": {"trust_gain": +10, "information": "some", "distance": "maintained"},
                    "requirements": {}
                },
                {
                    "text": "Supportive - 'Single parenthood must be tough'",
                    "consequences": {"trust_gain": +15, "emotional_support": True, "appreciation": "high"},
                    "requirements": {"social_awareness": 50}
                },
                {
                    "text": "Casual - Keep conversation light",
                    "consequences": {"trust_gain": +5, "safe_approach": True, "progress": "slow"},
                    "requirements": {}
                }
            ],
        ...
        print("Elena and Sofia have developed a routine - coffee breaks on the hospital roof.")
        ...
        print('       the weird death lady. Everyone else gets uncomfortable when I talk about work."')
        
        print(f'\n{social_agent.name}: "Death isn\'t weird - it\'s just part of life.')
        print('                     Someone has to speak for people who can\'t speak for themselves."')
        
        print('\nElena looks thoughtful: "That\'s... actually really beautiful.')
        print('                        \'Speaking for the dead.\' I never thought of it that way."')
        ...
        print('       "But when I write it up, my supervisor just files it as depression."')
            ...
            options=[
                {
                    ...
                    "consequences": {"recruitment": "direct", "betrayal_feeling": "high", "success": "uncertain"},
                    "requirements": {}
                },
                {
                    "text": "Gather more intel - 'That sounds frustrating. Tell me more?'",
                    "consequences": {"information": "more", "manipulation": "continued", "guilt": "building"},
                    "requirements": {}
                },
                {
                    "text": "Genuine support - Focus on Elena's emotional needs first",
                    "consequences": {"friendship": "deepened", "ethics": "preserved", "delay": True},
                    "requirements": {"moral_integrity": 70}
                },
                {
                    "text": "Plant seeds - 'What would you do if you could expose it?'",
                    "consequences": {"subtle_influence": True, "manipulation": "light", "preparation": True},
    ...
    def _resolve_recruitment_mission(self, mission_state: MissionState, choice_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        print('       maybe I\'d get promoted, make more money. But then I couldn\'t live with myself."')
    ...
    def _handle_honest_recruitment(self, mission_state: MissionState) -> Dict[str, Any]:
            ...
            options=[
                {
                    ...
                    "consequences": {"honesty": "complete", "trust": "rebuilt", "recruitment": "ethical"},
                    "requirements": {"moral_courage": 80}
                },
                {
                    "text": "Practical help - 'We'll get Diego's treatment regardless'",
                    "consequences": {"compassion": "shown", "no_strings": True, "loyalty": "earned"},
                    "requirements": {"resources": 100}
                },
                {
                    "text": "Choice freedom - 'If you say no, I disappear. No consequences.'",
                    "consequences": {"pressure": "none", "respect": "maximum", "agency": "preserved"},
                    "requirements": {}
                },
                {
                    "text": "Friendship priority - 'Handler or not, I want you in my life'",
                    "consequences": {"relationship": "prioritized", "human_connection": True},
        ...
        if recruitment_chance > 0.7:
            ...
            print('       For Diego. I want him to grow up in a world where the truth matters."')
            
            return self._create_mission_result("success", 
                "Ethical recruitment successful - genuine friendship and loyalty established")
        else:
            print('\nElena: "I need time to think about this."')
            return self._create_mission_result("partial_success", 
    ...
    def _handle_manipulative_recruitment(self, mission_state: MissionState) -> Dict[str, Any]:
        """Handle recruitment using manipulation tactics"""
        return self._create_mission_result("success", 
            "Recruitment successful through manipulation, but at what cost?")
    
    def _handle_assassination_scenario(self, mission_state: MissionState) -> Dict[str, Any]:
        """Handle the assassination scenario"""
        return self._create_mission_result("success", 
            "Assassination completed, but the moral weight remains...")
    
    def _resolve_capture_mission(self, mission_state: MissionState, result: Dict) -> Dict[str, Any]:
        """Resolve a capture mission"""
        return self._create_mission_result("success", 
            "Target captured and extracted successfully")
    ...
    def _apply_mission_results(self, result: Dict[str, Any], agents: List[Agent]) -> None:
        """Apply mission results to game state and agents"""
        # This would be implemented to update agent states, relationships, etc.
        pass


def execute_enhanced_mission(game_state, mission, agents: List[Agent]) -> Dict[str, Any]:
    """
