    ...
    class GameCLI:
        ...
        def setup_sample_game(self):
            ...
            locations = [
                ...
                Location(
                    "industrial", "Industrial Zone", security_level=5, unrest_level=6
                ),
            ...
            factions = [
                ...
                Faction(
                    "workers",
                    "Workers Union",
                    {"money": 200, "influence": 40, "personnel": 12},
                ),
            ]
            ...
            agents = [
                Agent(
                    ...
                    background="student",
                    skills={
                        SkillType.PERSUASION: Skill(SkillType.PERSUASION, level=7),
                ...
                Agent(
                    ...
                    background="military",
                    skills={
                        SkillType.COMBAT: Skill(SkillType.COMBAT, level=6),
                ...
                Agent(
                    ...
                    background="student",
                    skills={
                        SkillType.PERSUASION: Skill(SkillType.PERSUASION, level=5),
                ...
                Agent(
                    ...
                    background="civilian",
                    skills={
                        SkillType.SURVIVAL: Skill(SkillType.SURVIVAL, level=4),
                ...
                Agent(
                    ...
                    background="civilian",
                    skills={
                        SkillType.SURVIVAL: Skill(SkillType.SURVIVAL, level=5),
        ...
        def _setup_sample_equipment(self):
            ...
            equipment_templates = [
                Equipment(
                    ...
                    quality=6,
                    skill_bonus={SkillType.COMBAT: 2},
                    cost=50,
                ),
                Equipment(
                    id="rifle",
                    ...
                    equipment_type=EquipmentType.WEAPON,
                    quality=8,
                    skill_bonus={SkillType.COMBAT: 3},
                    cost=100,
                ),
                Equipment(
                    id="vest",
                    ...
                    quality=7,
                    skill_bonus={SkillType.SURVIVAL: 1},
                    cost=75,
                ),
                Equipment(
                    id="laptop",
                ...
                Equipment(
                    ...
                    quality=4,
                    skill_bonus={SkillType.STEALTH: 1},
                    cost=15,
                ),
                Equipment(
                    id="car",
                    ...
                    quality=5,
                    skill_bonus={SkillType.DRIVING: 1},
                    cost=200,
                ),
                Equipment(
                    id="radio",
                    ...
                    equipment_type=EquipmentType.ELECTRONIC,
                    quality=3,
                    skill_bonus={SkillType.TECHNICAL: 1},
                    cost=10,
                ),
            ]
        ...
        def _assign_sample_equipment(self, agents: List[Agent]):
            ...
            agents[5].add_equipment(
                Equipment(
                    id="pedro_binoculars",
                    name="Pedro's Binoculars",
                    equipment_type=EquipmentType.TOOL,
                    quality=4,
                    skill_bonus={SkillType.STEALTH: 1},
                    cost=15,
        ...
        def _add_sample_tasks(self):
            ...
            maria.add_task(
                Task(
                    ...
                    difficulty=4,
                    description="Scout government facility",
                )
            )
            maria.add_task(
                Task(
                    TaskType.MOVE,
                    target_location_id="government",
                    difficulty=6,
                    description="Infiltrate government quarter",
                )
            )
            maria.add_task(
                Task(
            ...
            carlos.add_task(
                Task(
                    TaskType.PROPAGANDA,
                    difficulty=5,
                    description="Distribute leaflets in downtown",
                )
            )
            carlos.add_task(
                Task(TaskType.RECRUIT, difficulty=6, description="Recruit sympathizers")
            )
            ...
            ana.add_task(
                Task(
                    TaskType.PROPAGANDA,
                    difficulty=3,
                    description="Organize student protest",
                )
            )
            ana.add_task(
                Task(
                    TaskType.RECRUIT,
                    difficulty=4,
                    description="Rally student supporters",
                )
            )
            ...
            jorge.add_task(
                Task(
                    TaskType.GATHER_INFO,
                    difficulty=5,
                    description="Monitor factory security",
                )
            )
            jorge.add_task(
                Task(
                    TaskType.MOVE,
                    target_location_id="downtown",
                    difficulty=4,
                    description="Report to headquarters",
                )
            )
            ...
            elena.add_task(
                Task(
                    TaskType.RECRUIT,
                    difficulty=5,
                    description="Organize factory workers",
                )
            )
            elena.add_task(
                Task(
                    TaskType.PROPAGANDA, difficulty=4, description="Spread strike plans"
                )
            )
            ...
            pedro.add_task(
                Task(
                    TaskType.GATHER_INFO,
                    difficulty=3,
                    description="Monitor police patrols",
                )
            )
            pedro.add_task(
                Task(
                    TaskType.MOVE,
                    target_location_id="industrial",
                    difficulty=3,
                    description="Coordinate with workers",
                )
            )
        ...
        def display_current_status(self):
            ...
            for faction_id, resources in status["factions"].items():
                ...
                print(
                    f"  {faction_name}: ${money} | Influence: {influence} | Personnel: {personnel}"
                )
        ...
        def show_agent_details(self):
            ...
            print("-" * 60)
            print(
                f"{'Name':<15} {'Status':<10} {'Location':<15} {'Tasks':<8} {'Skills'}"
            )
            print("-" * 60)
            ...
            for agent in self.game_state.agents.values():
                ...
                print(
                    f"{agent.name:<15} {status_icon}{agent.status:<9} {location_name:<15} {task_count:<8} {skills_str}"
                )
            ...
            choice = input(
                "\nEnter agent name for details (or press Enter to return): "
            ).strip()
            if choice:
                # Find the agent
                selected_agent = None
        ...
        def _show_agent_detail(self, agent):
            ...
            for skill_type, skill in agent.skills.items():
                ...
                if skill.level > 1:
                    print(
                        f"  • {skill_type.value}: {skill.level} (effective: {effective_level})"
                    )
                else:
                    print(
                        f"  • {skill_type.value}: {skill.level} (effective: {effective_level}) - Basic"
                    )
            ...
            if agent.equipment:
                ...
                for equipment in agent.equipment:
                    condition_status = (
                        "🟢"
                        if equipment.condition > 70
                        else "🟡"
                        if equipment.condition > 30
                        else "🔴"
                    )
                    print(
                        f"  {condition_status} {equipment.name} (condition: {equipment.condition}%)"
                    )
            ...
            if agent.task_queue:
                ...
                for i, task in enumerate(agent.task_queue[:5]):  # Show first 5 tasks
                    print(
                        f"  {i+1}. {task.task_type.value} (difficulty: {task.difficulty}, priority: {task.priority})"
                    )
                    if task.description:
        ...
        def add_task_to_agent(self):
            ...
            try:
                ...
                if selected_agent.status != "active":
                    print(
                        f"❌ Cannot assign task: {selected_agent.name} is {selected_agent.status}."
                    )
                    return
                ...
                try:
                    priority = int(
                        input("Enter priority (1-5, higher = more urgent): ")
                    )
                ...
                if selected_task_type == TaskType.MOVE:
                    ...
                    available_locations = [
                        ...
                        if loc.id != selected_agent.location_id
                    ]
                ...
                print(
                    f"✅ Task '{selected_task_type.value}' assigned to {selected_agent.name} successfully!"
                )
        ...
        def show_active_missions(self):
            ...
            for mission_id, mission in self.game_state.active_missions.items():
                location_name = self.game_state.locations[
                ...
                # Show success chance
                success_chance = mission.get_mission_success_chance(
        ...
        def create_mission(self):
            ...
            try:
                ...
                for i, location in enumerate(location_list, 1):
                    print(
                        f"  {i}. {location.name} (Security: {location.security_level}, Unrest: {location.unrest_level})"
                    )
                ...
                print("Now add agents to the mission using command 8.")
        ...
        def add_agent_to_mission(self):
            ...
            for i, mission in enumerate(mission_list, 1):
                ...
                faction_name = self.game_state.factions[mission.faction_id].name
                print(
                    f"  {i}. {mission.mission_type.value} at {location_name} ({faction_name}) - {len(mission.participants)} agents"
                )
            ...
            try:
                ...
                available_agents = [
                    agent
                    for agent in self.game_state.agents.values()
                    if agent.faction_id == selected_mission.faction_id
                ...
                available_agents = [
                    ...
                    if agent.id not in mission_agent_ids
                ]

                if not available_agents:
                    print(
                        "No available agents from this faction to add to the mission."
                    )
                    return
                ...
                # Get risk level
                risk_level = int(
                    input("Enter risk level (1-5, higher = more dangerous): ")
                )
                risk_level = max(1, min(5, risk_level))

                # Add agent to mission
                success = self.game_state.add_agent_to_mission(
                    selected_mission.id, selected_agent.id, selected_role, risk_level
                )

                if success:
                    print(
                        f"✅ Added {selected_agent.name} to mission as {selected_role.value}"
                    )
                    print(
                        f"Mission coordination: {selected_mission.coordination_level}%"
                    )
                else:
        ...
        def execute_mission(self):
            ...
            ready_missions = [
                mission
                for mission in self.game_state.active_missions.values()
                if len(mission.participants) >= 2
            ]

            if not ready_missions:
                print(
                    "No missions ready for execution. Missions need at least 2 participants."
                )
                return
            ...
            for i, mission in enumerate(ready_missions, 1):
                ...
                print(
                    f"  {i}. {mission.mission_type.value} at {location_name} ({faction_name})"
                )
                print(
                    f"     Participants: {len(mission.participants)}, Success: {success_chance}%"
                )
            ...
            try:
                ...
                confirm = (
                    input(
                        f"Execute {selected_mission.mission_type.value} mission? (y/n): "
                    )
                    .strip()
                    .lower()
                )
        ...
        def show_public_opinion(self):
            ...
            support_emoji = (
                "🟢"
                if opinion.general_support > 60
                else "🟡"
                if opinion.general_support > 40
                else "🔴"
            )
            print(
            ...
            influence_emoji = (
                "🟢"
                if opinion.political_influence > 20
                else "🟡"
                if opinion.political_influence > -20
                else "🔴"
            )
            ...
            if opinion.community_relations:
                ...
                for community, support in opinion.community_relations.items():
                    support_emoji = (
                        "🟢" if support > 60 else "🟡" if support > 40 else "🔴"
                    )
        ...
        def run(self):
            ...
            while True:
                ...
                if action == "advance":
                    ...
                    print(
                        "❌ Invalid command. Please enter a number or keyword from the menu."
                    )
