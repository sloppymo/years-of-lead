...
class EquipmentTestSuite:
        ...
        for item_id, equipment in self.equipment_registry.items():
            ...
            if equipment.durability.condition < 1.0:
                ...
                self.log_test(
                    ...
                    repair_success
                    and equipment.durability.condition > initial_condition,
    ...
    def test_concealment_system(self):
        ...
        for item_id, equipment in self.equipment_registry.items():
            ...
            container_concealment = equipment.get_effective_concealment(
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print("✅ Equipment variety expansion: Working")
            print("✅ Quality & durability system: Working")
            print("✅ Equipment effects & bonuses: Working")
            print("✅ Enhanced concealment: Working")
