...
class TestVictoryDefeatConditions(unittest.TestCase):
    ...
    def test_defeat_condition_met(self):
        ...
        self.mock_game.total_agents = 10
        self.mock_game.factions = {"resistance": MagicMock(control_level=0.05)}
    ...
    def test_progress_tracking(self):
        ...
        # Mock current state
        self.mock_game.factions = {"resistance": MagicMock(control_level=0.6)}
    ...
    def test_save_on_victory_defeat(self):
        ...
        victory_data = {"victory_achieved": True, "victory_type": "faction_control"}
