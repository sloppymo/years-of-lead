...
class PatternEngine:
    ...
    def __init__(self):
        ...
        self.emotion_keywords = {
            "sadness": [
                "sad", "depressed", "hurt", "crying", "tears", "grief", "mourning", 
                "despair", "defeated", "hopeless", "empty", "broken", "tired", "loss"
            ],
            "anger": [
                "hate", "rage", "furious", "bitter", "angry", "mad", "irritated",
                "frustrated", "annoyed", "outraged", "livid", "seething", "hostile",
                "resentful", "vengeful", "aggressive", "violent", "explosive"
            ],
            "anxiety": [
                "panic", "nervous", "worry", "anxious", "jittery", "restless", "uneasy",
                "apprehensive", "dread", "horror", "paralyzed", "frozen", "stressed", "tense"
            ],
            "shame": [
                "ashamed", "embarrassed", "dirty", "guilt", "shameful", "disgusting",
                "unworthy", "defective", "damaged", "tainted", "contaminated", "impure",
                "sinful", "bad", "wrong", "inadequate", "worthless"
            ],
            "overwhelm": [
                "too much", "can't breathe", "drowning", "suffocating", "crushed",
                "buried", "trapped", "stuck", "numb", "disconnected", "spaced out",
                "overwhelmed", "exhausted", "drained"
            ],
            "grief": [
                "missing", "gone", "died", "death", "bereaved", "grieving", "heartbroken",
                "devastated", "destroyed", "shattered", "void", "hollow", "left behind"
            ],
            "fear": [
                "afraid", "scared", "terrified", "horrified", "petrified", "frightened",
                "intimidated", "threatened", "vulnerable", "exposed", "unsafe",
                "dangerous", "risky", "threatening", "hostile", "danger"
            ],
            "loneliness": [
                "alone", "lonely", "isolated", "separated", "disconnected", "abandoned",
                "rejected", "excluded", "left out", "ignored", "invisible", "unseen",
                "unheard", "forgotten", "deserted", "stranded"
            ]
        }
    ...
    def analyze_emotion_frequencies(self, memory_entries: List[Dict], timeframes: List[int] = [7, 30, 90]) -> Dict[str, Dict[str, int]]:
        """
            ...
            for entry in memory_entries:
                try:
                    ...
                    if entry_date >= cutoff_date:
                        ...
                        if user_input and not user_input.startswith("/"):  # Skip commands
    ...
    def analyze_subsystem_tension(self, memory_entries: List[Dict], days: int = 30) -> Dict[str, any]:
        """
        ...
        if total_activity == 0:
            return {"balance": "equilibrium", "tension_level": "minimal", "dominant_subsystem": None}
    ...
    def determine_ritual_intensity(self, emotion_counts: Dict[str, int], subsystem_tension: Dict[str, any]) -> str:
        """
        ...
        intense_count = sum(emotion_counts.get(emotion, 0) for emotion in intense_emotions)
    ...
    def detect_drift_patterns(self, memory_entries: List[Dict], comparison_days: Tuple[int, int] = (7, 30)) -> Optional[str]:
        """
        ...
        historical_analysis = self.analyze_subsystem_tension(memory_entries, comparison_days)
